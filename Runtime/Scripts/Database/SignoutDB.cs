...
public static class SignoutDB
{
    ...
    public static IEnumerator Signout(UnityAction<ErrorMessage, bool> onCompleted)
    {
        ...
        {
            Debug.Log("Successful signout: " + request.downloadHandler.text);
